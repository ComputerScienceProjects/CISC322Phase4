...
public class TextEditor extends Application {
	...
	DocumentType textFac = new TextType();
	DocumentType CSVFac = new CSVType();
	DocumentManager manager = getDocumentManager();
	//System.err.println("Got to return from getDocumentManager");
	if (manager!=null) {
	    manager.addExtension(textFac);
	    manager.addExtension(CSVFac);
	}
	...
	if (newAction!=null)
	    newAction.setAction(new NewAction(textFac));
