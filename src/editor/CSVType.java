...
//    /* Commenting this out as this is for menu items that already exist, rather than new ones created.
...
//		menu.addElement(new MenuElement("Edit/Upper Case", new UpCaseAction()));
		...
		menu.addElement(new MenuElement("View/Column Statistics", new ColumnStatisticsAction()));
		menu.addElement(new MenuElement("View/Unsort", new UnsortAction()));
	    } catch (Exception e) {
